...
rc=0
for probe in manifest_schema_validate truth_ledger_lint content_lint bilingual_parity_check image_plan_check contrast_audit perf_budget_check secrets_scan header_csp_scan privacy_scan sca_triage deploy_readiness live_verify monitoring_state_check verify_event_chain; do
  echo "----------------------------------------------"
